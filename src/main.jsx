...
const StripeFrostingStudio    = lazy(() => import('./admin/StripeFrostingStudio.jsx'));
...
const ROUTES = {
  ...
  '/elements/stripe-frosting':     StripeFrostingStudio,
...
const NAV_GROUPS = [
  ...
  { title: 'Editors', index: '/editors', items: [
    ...
    { href: '/elements/stripe-frosting',  label: 'Stripe Frosting' },
