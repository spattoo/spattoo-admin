...
const BandFrostingStudio    = lazy(() => import('./admin/BandFrostingStudio.jsx'));
...
const ROUTES = {
  ...
  '/elements/band-frosting':     BandFrostingStudio,
...
const NAV_GROUPS = [
  ...
  { title: 'Editors', index: '/editors', items: [
    ...
    { href: '/elements/band-frosting',  label: 'Band Frosting' },
